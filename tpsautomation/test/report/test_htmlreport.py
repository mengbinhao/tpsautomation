...
def test_get_date_and_time_as_datetime():
    result_list = [{'id': 1, 'name': 'case01', 'runresult': 'pass', 'runtime': datetime.datetime.now(), 'runduration': '10分', 'htmlclass': 'success', 'reason': '成功'},
                   {'id': 2, 'name': 'case02', 'runresult': 'pass', 'runtime': datetime.datetime.now(
                   ), 'runduration': '10分', 'htmlclass': 'success', 'reason': '成功'},
                   {'id': 3, 'name': 'case03', 'runresult': 'fail', 'runtime': datetime.datetime.now(
                   ), 'runduration': '10分', 'htmlclass': 'danger', 'reason': '失败'},
                   {'id': 4, 'name': 'case04', 'runresult': 'fail', 'runtime': datetime.datetime.now(
                   ), 'runduration': '10分', 'htmlclass': 'danger', 'reason': '失败'},
                   {'id': 5, 'name': 'case05', 'runresult': 'fail', 'runtime': datetime.datetime.now(
                   ), 'runduration': '10分', 'htmlclass': 'danger', 'reason': '失败'}
                   ]
    title = '自动化测试报告'
